...
echo $yellow."
[!] Author   : HAPID GANS	              [☆]
[!] BROTHER'S: HAPID-OZINO-WAHYU-NISA-
               SHINCLAIR-FROZEN FLAMES
               DILBEWILD DAN MEMBER LAIN NYAH [☆]
[!] github   : https://githb.com/CSI-WHI      [☆]\n";
echo $green."
======================================
|[!]  CYBER SECURITI INDONESIA WHI  [!]|
======================================\n";
echo "\n";
echo "\n";
echo "@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@\n";
...
echo " \n";
sleep ('0.4');
echo "root@.Hapid.gans=# Masukan No Hp Target #-> ";
$no = get();
$n = new prankCall($no);
$n->run();
